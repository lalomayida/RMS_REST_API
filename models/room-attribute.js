class room_attibute {
    ...
    get_assigned_room_attibutes(idRoom) {
        return `SELECT id_attribute as id, (SELECT name FROM room_attribute where id = id_attribute), quantity FROM public.room_attribute_assignation WHERE id_room = ` + idRoom
    }
